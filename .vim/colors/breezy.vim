...
if(&background == "dark")
    hi Normal        guibg=#151d22 guifg=#AFF0A8 gui=NONE
else
    hi Normal        guibg=#232629 guifg=#cfcfc2 gui=NONE
endif

hi LineNr        guibg=#040C11 guifg=#7a7c7d gui=NONE
...
hi Underlined     guibg=NONE    guifg=#27ae60 gui=NONE
...
hi CursorLine    guibg=#262E33 guifg=NONE    gui=NONE term=bold cterm=bold
...
hi VisualNOS     guibg=NONE    guifg=NONE    gui=NONE
