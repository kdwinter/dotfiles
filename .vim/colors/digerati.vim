...
if version >= 700
  hi CursorLine   guibg=#262E33 cterm=none
...
hi Normal        guifg=#f0f0f0 guibg=#151D22 gui=none
hi NonText 		   guifg=#a0a0a0 guibg=#040C11 gui=none
hi LineNr        guifg=#404040 guibg=#040C11 gui=none
